...
namespace AVIVA.Application.Test.Features.Orders.Commands.Pay
{
    public class PayOrderCommandHandlerTest
    {
        ...
        public async Task Handle_ShouldUpdateOrderStatusToPaid_WhenPaymentIsSuccessful()
        {
            ...
            _paymentProviderService.Setup(s => s.PayOrder(It.IsAny<string>(), It.IsAny<PaymentProviderConfig>()))
